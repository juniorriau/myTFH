...
/**
 * Handle dashboard for allowed applications (using authentication service)
 *
 ...
 *
 * @category   views
 * @discussion Handles the dashboard for visitor ACL's
 ...
 *  @abstract Handles the dashboard for allowed applications
 */
class dashboardApplicationsController
{
			...
			if (($l) && ($g)) {
				switch($l) {
					...
					case (($l === "admin") && ($g === "admin")):
						$p = 'views/admin/view.dashboardApplications.php';
						$c = 'dashboardApplicationsView';
						break;
					/* group super user, admin access level and non-admin group membership */
					case (($l === "admin") && ($g !== "admin")):
						$p = 'views/admin/view.dashboardAapplications.php';
						$c = 'dashboardApplicationsView';
						break;
