...
class installationView
{
	...
	/**
	 *! @function _info
	 *  @abstract Loads the installation info template
	 */
	private function _info()
	{
		$this->registry->tpl->assign('login', $this->registry->tpl->assign(null, null, 'info.tpl', true, $this->registry->libs->_getRealIPv4()), null, null);
	}
