...
CREATE DEFINER='licensing'@'localhost' PROCEDURE Configuration_applications_add(IN `application` VARCHAR(255), IN `url` VARCHAR(255), IN `ip` LONGTEXT, `skey` LONGTEXT)
 DETERMINISTIC
